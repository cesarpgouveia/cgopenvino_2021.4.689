...
int main(int argc, char* argv[]) {
    try {
        ...
        /** Read network model **/
        std::string modelPath = "C:/Users/cesar.gouveia/Projects/vbresearch-face-models/VisionBox.NeutralExpression.xml";
        std::string binPath = "C:/Users/cesar.gouveia/Projects/vbresearch-face-models/VisionBox.NeutralExpression.bin";
        CNNNetwork network = ie.ReadNetwork(modelPath, binPath);
        // -----------------------------------------------------------------------------------------------------
